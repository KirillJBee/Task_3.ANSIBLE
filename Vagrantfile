Vagrant.configure("2") do |config|
    ...
    config.vm.network "public_network", ip: "192.168.1.225",  bridge: "wlp1s0"
    ...
    echo "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIOXBhFDigqdwbiYWZAbZnr/Fh2Rl1JWxjhePQsHNAWGW" >> /home/user/.ssh/authorized_keys
